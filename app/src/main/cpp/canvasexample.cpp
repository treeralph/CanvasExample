...
//    jobject jthNode;
//    jobject jthEdge;
//    jobject jthNode1Object;
//    jobject jthNode2Object;
//    jobject jthNode1IndexObject;
//    jobject jthNode2IndexObject;
//    jstring jthNode1IndexString;
//    jstring jthNode2IndexString;
//    jobject targetNode;
//
//    for (jint i=0; i<nodeLen; i++) {
//        ithNode = env ->CallObjectMethod(nodes, java_util_ArrayList_get, i);
