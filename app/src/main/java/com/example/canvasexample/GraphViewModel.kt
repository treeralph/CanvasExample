...
//    private var linLogMode: Boolean = false
//
...
//            val data1 = _nodeDao.getAllNodes()
//            val data2 = _edgeDao.getAllEdges()
//            data1.forEachIndexed { index, node ->
//                data1[index].x = Random.nextDouble(-30.0, 30.0)
//                data1[index].y = Random.nextDouble(-30.0, 30.0)
//            }
//            _nodes.addAll(data1)
//            _nodes.forEachIndexed { index, node -> _nodeId2Index[node.id] = index }
//            _nodesTemper.addAll(data1)
...
//            sum / it.size
//        }
//        var attractionCoef = if (outboundAttractionDistribution) outboundAttractionCompensation else 1.0
//        var attraction = getAttraction(attractionCoef, linLogMode)
//
